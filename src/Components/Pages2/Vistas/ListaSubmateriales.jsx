import { Button, Dialog, Paper, Box, Container, Grid, Tooltip, TableCell, makeStyles, Typography, TableContainer, Table, TableHead, TableRow, TableBody, IconButton, InputAdornment, TextField, CircularProgress, MenuItem } from '@material-ui/core'
...
import { ErrorAlertsEditSubMaterial, SuccessAlertsEditSubMaterial } from '../../Atoms/Alerts/Alerts'
        ...
        <>
            ...
            <Container maxWidth='lg'>
                <Grid container direction='row' justifyContent='space-between' alignItems='center' style={{ marginBottom: '0.5rem' }}>
                    <RegisterSubMaterial dos={url} uno={getDataSubMaterial} />
                    <div>
                        {subMaterialData &&
                            <TextField
            ...
            >
                <Paper component={Box} p={2} /*style={{ background: '#bdbdbd', width: '300px', height: '300px' }}*/>
                    <div align='right'>
                        <IconButton style={{color:'#212121'}} size='small' onClick={closeModalImage}>
                            <CancelPresentationIcon style={{width:'30px',height:'30px'}} />
                        </IconButton>
                    </div>
